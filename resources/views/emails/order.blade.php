        ...
        <tr>
            <td>
                <div style="overflow:hidden;display:none;font-size:1px;color:#ffffff;line-height:1px;font-family:Arial;maxheight:0px;max-width:0px;opacity:0;">
                    Pesanan Anda Dikirim {{ $order->invoice }}
                </div>
            </td>
        </tr>
    </table>
                            ...
                            <table border="0" align="center" width="590" cellpadding="0" cellspacing="0" class="container590">
                                ...
                                <tr>
                                    <td align="center" height="70" style="height:70px;">
                                        <a href="" style="display: block; border-style: none !important; border: 0 !important;"><img width="250" border="0" style="display: block; width: 250px;" src="https://lh3.googleusercontent.com/d/1gqN1INphne30es-fwkqNbxkxTq2oihlN?authuser=0" alt="" /></a>
                                    </td>
                                </tr>
                            </table>
                        </td>
                ...
                <table border="0" align="center" width="590" cellpadding="0" cellspacing="0" class="container590">
                    <tr>
                        ...
                        <td align="center" class="section-img">
                            <a href="" style=" border-style: none !important; display: block; border: 0 !important;"><img src="https://lh3.googleusercontent.com/d/1zTln-x55gZ0uLUzrunDZHUW5-MGpCE09?authuser=0" style="display: block; width: 590px;" width="590" border="0" alt="" /></a>
                    ...
                    <tr>
                        <td align="center" style="color: #343434; font-size: 24px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;" class="main-header">
                            ...
                            <div style="line-height: 35px">
                                ...
                                Hi <span style="color: #f27272;">{{ $order->customer->name }}</span>
                                ...
                                <tr>
                                    <td align="center" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                        ...
                                        <div style="line-height: 24px">
                                            Terima kasih telah melakukan transaksi pada aplikasi kami, berikut nomor resi dari pesanan anda: <strong style="color: #f27272">{{ $order->tracking_number }}</strong>
                                        </div>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td align="center">
                            <table border="0" align="center" width="160" cellpadding="0" cellspacing="0" bgcolor="5caad2" style="background-color: #f27272">
                                ...
                                <tr>
                                    <td align="center" style="color: #ffffff; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 26px;">
                                        ...
                                        {{-- <div style="line-height: 26px;">
                                            <a href="{{ route('customer.verify', $customer->activate_token) }}" style="color: #ffffff; text-decoration: none;">Verifikasi disini!</a>
                                        </div> --}}
                                    </td>
                                </tr>
                        ...
                        <td>
                            <table border="0" width="300" align="left" cellpadding="0" cellspacing="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="container590">
                                ...
                                <tr>
                                    <!-- logo -->
                                    <td align="left">
                                        <a href="" style="display: block; border-style: none !important; border: 0 !important;"><img width="150" border="0" style="display: block; width: 150px;" src="https://lh3.googleusercontent.com/d/1gqN1INphne30es-fwkqNbxkxTq2oihlN?authuser=0" alt="" /></a>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td align="left" style="color: #888888; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 23px;" class="text_color">
                                        <div style="color: #333333; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; font-weight: 600; mso-line-height-rule: exactly; line-height: 23px;">
                                            ...
                                            Email us: <br/> <a href="mailto:" style="color: #888888; font-size: 14px; font-family: 'Hind Siliguri', Calibri, Sans-serif; font-weight: 400;">lsastariasukses@gmail.com</a>
                                ...
                                <tr>
                                    <td align="left" style="color: #aaaaaa; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                        <div style="line-height: 24px;">
                                            ...
                                            <span style="color: #333333;">Copyright &copy;2021 PT LAROSSA SUKSESTAMA | MAJALENGKA</span>
